...
from app.services.gemini_service.gemini_service_build import BUILDERS_GEMENI as BUILDERS
from app.services.gemini_service.gemini_service_build import build_default_gemini
...
async def gemini_answer(mode: ChatMode, user_text: str, **kw: Any) -> str:
    ...
    builder_func = BUILDERS.get(mode) or build_default_gemini
